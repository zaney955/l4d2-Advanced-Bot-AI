...
function I18n::init() {
	local english =  {
		...
		botai_overpowered_combat_boost_on = "Overpowered combat boosts enabled (12 non-vanilla combat boosts active).",
		botai_overpowered_combat_boost_off = "Overpowered combat boosts disabled (12 non-vanilla combat boosts inactive).",
		...
		menu_overpowered_combat_boost = "Overpowered Combat Boosts",
	...
	local schinese =  {
		...
		botai_overpowered_combat_boost_on = "Bot外挂式战斗增强已开启（12项非原版战斗增强已生效）",
		botai_overpowered_combat_boost_off = "Bot外挂式战斗增强已关闭（12项非原版战斗增强已禁用）",
		...
		menu_overpowered_combat_boost = "外挂式战斗增强",
	...
	local tchinese =  {
		...
		botai_overpowered_combat_boost_on = "Bot外掛式戰鬥增強已開啟（12項非原版戰鬥增強已生效）",
		botai_overpowered_combat_boost_off = "Bot外掛式戰鬥增強已關閉（12項非原版戰鬥增強已禁用）",
		...
		menu_overpowered_combat_boost = "外掛式戰鬥增強",
